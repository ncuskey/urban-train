 ...
 */
export function getLandSortedDesc(cells) {
 ...
 */
export function resolveDepressions(cells, opts) {
    ...
    for (; passes < maxPasses; passes++) {
        ...
        for (const c of land) {
            ...
            if (liftsThisPass >= maxLiftsPerPass)
                break;
        }
        lastLiftCount = liftsThisPass;
        if (liftsThisPass === 0)
            break; // stable, no more depressions
    }
