...
import { buildCoastlines } from "./coast";
 ...
 */
function mkPlusIsland() {
    const O = seaLevel - 0.1, L = seaLevel + 0.2;
    const cells = [
        { id: 0, x: 0, y: -1, polygon: [], neighbors: [2], height: O, precipitation: 0.02, flux: 0.02 },
        { id: 1, x: -1, y: 0, polygon: [], neighbors: [2], height: L, precipitation: 0.02, flux: 0.02 },
        { id: 2, x: 0, y: 0, polygon: [], neighbors: [0, 1, 3, 4], height: L, precipitation: 0.02, flux: 0.02 },
        { id: 3, x: 1, y: 0, polygon: [], neighbors: [2], height: L, precipitation: 0.02, flux: 0.02 },
        { id: 4, x: 0, y: 1, polygon: [], neighbors: [2], height: L, precipitation: 0.02, flux: 0.02 },
        { id: 5, x: -2, y: 0, polygon: [], neighbors: [], height: O, precipitation: 0.02, flux: 0.02 },
        { id: 6, x: 2, y: 0, polygon: [], neighbors: [], height: O, precipitation: 0.02, flux: 0.02 },
        { id: 7, x: 0, y: 2, polygon: [], neighbors: [], height: O, precipitation: 0.02, flux: 0.02 },
        { id: 8, x: 0, y: -2, polygon: [], neighbors: [], height: O, precipitation: 0.02, flux: 0.02 },
    ];
